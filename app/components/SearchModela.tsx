...
//       className={`search-modal ${pagePadding} bg-primaryLight text-sm gap-2 absolute p-4 z-50 flex flex-col shadow-lg w-[100vw] h-[100vh] items-center left-0 top-0 rounded-md
//         `}
//     >
...
//                 <input value={searchValue} type='text' onChange={(e)=>setSearchValue(e.target.value)} className='border-b outline-none w-full h-6 border-primary bg-primaryLight px-1 text-sm'/>
