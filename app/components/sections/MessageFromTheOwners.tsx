...
const MessageFromTheOwners = () => {
  return (
    <div className='flex flex-col gap-4 justify-center text-center items-center px-4 md:px-8 w-full h-[60vh] md:h-[80vh] bg-pink3'>
        <motion.h1 
                variants={fadeIn({ direction: 'up', delay: 0.1 })}
                initial="hidden"
                whileInView="show"
                viewport={{ once: true, amount: 0.6 }}
        className='text-3xl md:text-5xl text-white'>Message From The Owners</motion.h1>
        <motion.h1 
