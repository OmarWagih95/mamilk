      ...
      <footer className="bg-primary text-blue2 py-10 sm:px-10 px-6 tracking-wide">
        <div className="flex-col-reverse w-full flex md:flex-row gap-8">
          <div className="md:w-1/4">
            <h4 className={`text-2xl ${Berkishire.className} font-bold mb-6`}>
              Policies
            </h4>
          ...
          <div className="md:w-1/4">
            ...
            <ul className="space-y-1">
              <li>
                <Link
                  target="#"
                  href="https://www.facebook.com/profile.php?id=61565209649532&mibextid=LQQJ4d"
                  className="text-white hover:text-secondary text-sm"
                >
                  FACEBOOK
                </Link>
              ...
              <li>
                <Link
                  target="#"
                  href="https://www.instagram.com/mamilk_breastfeeding/profilecard"
                  className="text-white hover:text-secondary text-sm"
                >
                  INSTAGRAM
                </Link>
...
"
          ...
          <div className="max-w-xl md:w-1/2 mx-auto text-start">
            <h3 className={`text-2xl ${Berkishire.className} font-bold`}>
              Newsletter
            </h3>
