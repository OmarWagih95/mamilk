...
<h2 className={`${Berkishire.className} text-pink3 mb-8 md:mb-16 text-3xl md:text-4xl lg:text-5xl`}>
  Shop By Collection
</h2>       
{/* <h2 className={`${Berkishire.className} text-transparent bg-clip-text bg-gradient-to-bl from-blue-500 via-purple-500 to-pink-600 mb-8 md:mb-16 text-3xl md:text-4xl lg:text-5xl`}>
  Shop By Collection
</h2>        */}
 <div className='flex uppercase w-full justify-between rounded-md h-[30vh] md:h-[70vh]'>
            ...
            <h1 className={`font-bold text-sm md:text-2xl xl:text-4xl ${Berkishire.className} `}>DRESSES</h1>
                </div>
        </div>
            </div>
            <div 
            ...
            <h1 className={`font-bold text-sm md:text-2xl xl:text-4xl ${Berkishire.className}`}>TOPS</h1>
                </div>
        </div>
            </div>
        </div>
        ...
        <div className='flex uppercase w-full justify-between rounded-md h-[20vh] md:h-[50vh]'>
            ...
            <h1 className={`font-bold text-sm md:text-2xl xl:text-4xl ${Berkishire.className} `}>Bottoms</h1>
                </div>
        </div>
            </div>
            <div 
            ...
            <div className='bg-pink2 flex justify-center items-center px-4 py-2 rounded-md mt-[15vh] md:mt-[20vh]'>
            <h1 className={`${Berkishire.className} font-bold text-sm md:text-2xl xl:text-4xl `}>Maternity</h1>
                </div>
        </div>
            </div>
            <div 
            ...
            <div className='bg-pink2 flex justify-center items-center px-4 py-2 rounded-md mt-[15vh] md:mt-[20vh]'>
            <h1 className={`font-bold text-sm md:text-2xl xl:text-4xl ${Berkishire.className}`}>SETS</h1>
                </div>
        </div>
            </div>
        </div>
