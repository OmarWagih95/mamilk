...
const ShopByCategories = () => {
  ...
  return (
    <div className='bg-backgroundColor space-y-4 w-full min-h-[50vh] px-4 md:px-8 py-8 md:py-16 h-auto text-center'>
<h2 className={`${Gluten.className} text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mb-8 md:mb-16 text-3xl md:text-4xl lg:text-5xl`}>
  Shop By Collection
</h2>        <div className='flex uppercase w-full justify-between rounded-md h-[30vh] md:h-[70vh]'>
            <div 
            ...
            <div className='bg-secondary/80 flex justify-center items-center px-4 py-2 rounded-md mt-[20vh] md:mt-[30vh]'>
        ...
        <div className='flex uppercase w-full justify-between rounded-md h-[20vh] md:h-[50vh]'>
            ...
            <div className='bg-secondary/80 flex justify-center items-center px-4 py-2 rounded-md mt-[15vh] md:mt-[20vh]'>
